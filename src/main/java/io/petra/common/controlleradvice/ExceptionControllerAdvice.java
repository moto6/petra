package io.petra.common.controlleradvice;

import io.petra.common.response.ApiResult;
import io.petra.favorite.exception.FavoriteDuplicationException;
import io.petra.account.exception.GuestForbiddenException;
import io.petra.article.exception.InvalidArticleQueryException;
import io.petra.account.exception.NoSuchAccountException;
import io.petra.account.exception.NoSuchAccountTypeException;
import io.petra.article.exception.OutOfDateArticleExposeException;
